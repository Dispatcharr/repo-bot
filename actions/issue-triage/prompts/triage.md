...
- Do not mention a related issue that was rejected as a canonical duplicate in `statusReason` or `comment`. Discuss it only when it is relevant to the selected disposition.
